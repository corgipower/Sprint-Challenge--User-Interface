...
Semantic HTML means using the most meaningful tags available.
...
For branching so features can be built/changed without breaking the rest of the project.
Also it allows multiple people to work on the project simultaneously.

5. Define mobile-first design in your own words.

Mobile-first is designing for a small viewport, then adding in larger breakpoints for bigger screens.
